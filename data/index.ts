...
const CARD_ID_MAPPING: Record<string, string> = {
  ...
  // Old set → new set (save game compatibility)
  'ATTACK_1': 'ATTACK_INCENDIARY_SALVO',
  'DEFEND_1': 'SKILL_BULWARK_PLATING',
  'REPAIR_1': 'SKILL_EMERGENCY_PATCH',
  'ENERGY_1': 'SKILL_FUEL_REROUTE',
  'BASE_REPARACION01': 'SKILL_EMERGENCY_PATCH',
  'ATTACK_BURN_BEAM': 'ATTACK_INCENDIARY_SALVO',
  'SKILL_HULL_BREACH': 'SKILL_SYSTEM_HACK',
  'SKILL_OVERCHARGE': 'SKILL_HEAT_SINK_FAILURE',
  'ATTACK_PLASMA_CANNON': 'ATTACK_OVERHEATING_BEAM',
  'SKILL_TARGETED_EMP': 'SKILL_DISRUPTOR_PULSE',
  'SKILL_OVERHEAT': 'SKILL_SYSTEM_HACK',
  'ATTACK_VOLLEY': 'ATTACK_PRECISION_VOLLEY',
  'ATTACK_PLASMA_BURST': 'ATTACK_OVERHEATING_BEAM',
  'SKILL_FOCUS': 'SKILL_TARGET_PAINTER',
  'SKILL_HOLOGRAPHIC_SHIELD': 'SKILL_KINETIC_BARRIER',
  'ATTACK_PHANTOM_STRIKE': 'ATTACK_CHAIN_DISCHARGE',
  'SKILL_COMBAT_PREP': 'SKILL_CARGO_DUMP',
  'CURSE_FATIGUE': 'CURSE_PLASMA_BLEED',
  'BASE_TORPEDO_COIN_10': 'ATTACK_INCENDIARY_SALVO',
  'CERBERUS_AZAR_NOMILITAR': 'SKILL_BULWARK_PLATING',
  'ATK_CAP_K': 'SKILL_EMERGENCY_PATCH',
  'REPAIR_KIT': 'SKILL_EMERGENCY_PATCH',
  'DFEN_D': 'SKILL_BULWARK_PLATING',
};
